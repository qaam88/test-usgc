...
_,results,_ = make_plot(clean_merged_data,'Overall',clean_merged_data.index.min(),clean_merged_data.index.max(),'CBOB')
...
sidebar = html.Div(
    [
        ...
        html.Div(id='price-output-data-upload'),
        ...
        html.Div(id='volume-output-data-upload'),
...
def update_plot(var1,n_clicks,price_contents,price_filename,price_last_modfidied,volume_contents,volume_filename,volume_last_modified,period,start_date,end_date,):
