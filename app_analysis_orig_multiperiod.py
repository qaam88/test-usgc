...
def make_plot(df,start_date1,end_date1,start_date2,end_date2,start_date3,end_date3,product):
    period_list = [[start_date1,end_date1],[start_date2,end_date2],[start_date3,end_date3]]
    frame = []
    
    for i in range(len(period_list)):
        placeholder = []
        summer_df = df[period_list[i][0]:period_list[i][1]].query('CBOB_RVP == 9')
        winter_df = df[period_list[i][0]:period_list[i][1]].query('CBOB_RVP > 9')
...
#         product_winter_df.describe()
    ...
    merged_df = pd.concat(frame, keys= ["period1_summer","period1_winter","period2_summer","period2_winter","period3_summer","period3_winter",])
