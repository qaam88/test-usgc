...
sidebar = html.Div(
    [
        ...
        html.Div('kindly select the timerange from within the highlighted dates (eg: pre-covid)'),
        dcc.DatePickerRange(
        ...
        html.Div('kindly select the timerange from within the highlighted dates (eg: post-covid)'),
        dcc.DatePickerRange(
        ...
        html.Div('kindly select the timerange from within the highlighted dates (eg: war)'),
        dcc.DatePickerRange(
...
def update_plot(var1,start_date1,end_date1,start_date2,end_date2,start_date3,end_date3):
    fig,_ = make_plot(clean_merged_data,start_date1,end_date1,start_date2,end_date2,start_date3,end_date3,var1)
    return fig
...
def update_summary(var1,start_date1,end_date1,start_date2,end_date2,start_date3,end_date3):
    _,result = make_plot(clean_merged_data,start_date1,end_date1,start_date2,end_date2,start_date3,end_date3,var1)
